...
public class ShopServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.isNew()) {
			...
			session.setAttribute("objects.ShoppingCart", new objects.ShoppingCart(request.getParameter("username")));
		}
		...
		out.println("<a href='cookies.html'><button>Review Cookies</button></a>");
